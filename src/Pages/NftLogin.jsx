...
export default function NftLogin() {
    ...
    <div className="sm:h-screen">
      <div className="relative sm:h-screen">
        <img
          ...
          alt="background page"
        />
        <div className="relative flex flex-col items-center justify-between xl:flex-row sm:h-screen px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
            <MotionComponent>
              ...
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                Fique de olho! Acompanhe nossos canais de comunicação e fique
                por dentro da nova coleção de NFT da Monkey, que será um grande
