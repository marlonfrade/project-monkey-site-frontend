...
export default function NftLogin({ theme, setTheme }) {
  ...
  return (
    <div className="container max-w-screen-xl mx-auto isolate">
      ...
      <div className="relative flex flex-col items-center justify-between xl:flex-row sm:h-screen px-4 py-6 lg:py-0 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
          <MotionComponent>
            <h2 className="max-w-lg mb-6 font-sans text-3xl text-center sm:text-start font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl sm:leading-none">
            ...
            <p className="max-w-xl mb-4 text-center sm:text-start text-gray-500 dark:text-gray-200 md:text-lg">
              Fique de olho! Acompanhe nossos canais de comunicação e fique por
              dentro da nova coleção de NFT da Monkey, que será um grande
              projeto para a comunidade de tecnologia.
            </p>
            <Link
              to="/"
              aria-label="Link Back to Home"
              className="flex justify-center items-center sm:justify-start font-semibold tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-red-600 via-red-500 to-purple-500"
            >
              Voltar para o Site
              <svg
        ...
        <div className="w-full max-w-xl p-6 m-auto mx-auto">
          <MotionComponent>
            <div className="w-full flex flex-col gap-y-4 justify-center items-center">
              ...
              <div className="w-full max-w-sm p-4 bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
                  Conecte sua carteira em uma das opções abaixo, ou faça login
                  com seu acesso.
                </p>
                  ...
                  <li>
                    ...
                    >
                      <svg
                        ...
                        fill="none"
                        stroke="currentColor"
                        className="h-5 stroke-2 text-red-500"
                      >
                        <path
                          d="M52 26V16a4 4 0 0 0-4-4H12a4 4 0 0 0-4 4v32a4 4 0 0 0 4 4h36a4 4 0 0 0 4-4V38"
                          fill="#CF202A"
                        />
                        <rect
                          x="48"
                ...
                <div>
                  ...
                  >
                    ...
                    {/* [ADJUSTS] - implement the tooltip component below */}
                    Porque eu preciso conectar minha carteira?
                  </a>
                </div>
              </div>
            </div>
