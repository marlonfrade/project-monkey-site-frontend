...
import EmailRedIcon from "../images/red-mail-icon.svg";
    ...
    <div className="sm:h-screen">
      <div className="relative sm:h-screen">
        <img
          ...
          alt=""
        />
        <div className="relative bg-gray-900 bg-opacity-75 sm:h-screen">
          <div className="flex justify-center items-center sm:h-screen px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="flex flex-col items-center justify-between xl:flex-row">
              ...
              <div className="w-full max-w-xl p-6 m-auto mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                <MotionComponent>
                  <div className="w-full flex flex-col gap-y-4 justify-center items-center">
                    ...
                    <div className="w-full max-w-sm p-4 bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Conecte sua carteira em uma das opções abaixo, ou faça
                        login com seu acesso.
                      </p>
